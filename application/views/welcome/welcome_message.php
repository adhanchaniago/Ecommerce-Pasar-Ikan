		...
		<div class=" con-w31">
			<?php foreach ($barang as $b) : ?>
				<div class="col-md-3 m-wthree">
					<div class="col-m">
						<img src="<?= base_url('assets/img/barang/') . $b['image_barang'] ?>" class="img-fluid" alt="" style="height:150px;width:300px;">
						<div class="mid-1">
							<div class="women">
							...
							<a href="<?= base_url('welcome/detail_barang_welcome/') . $b['id']; ?>" class="btn btn-warning">
								Lihat Detail
							</a>
						</div>
					</div>
