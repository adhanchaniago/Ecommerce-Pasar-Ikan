            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg">
                        ...
                        <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#TambahSubMenuModal">Add New Menu</a>
                        ...
                        <form action="<?= base_url('Menu/submenu'); ?>" method="post">
                            <div class="modal-body">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="title" name="title" placeholder="Input Judul Sub Menu">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="url" name="url" placeholder="Input url submenu Baru">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="icon" name="icon" placeholder="Input icon Menu">
                                </div>
                                <div class="form-group">
